  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["profile-profile-module"], {
    ...
    function ncJE(module, __webpack_exports__, __webpack_require__) {
      ...
      var ProfilePage = /*#__PURE__*/function () {
        function ProfilePage(navCtrl, route, modal, loading, rest) {
          ...
          value: function getdetails() {
            ...
            this.rest.sendRequest("get_profile_details", senddata).subscribe(function (data) {
              ...
              if (data.status == 'success') {
                ...
                _this.Id = data.data.users_id;
                _this.fname = data.data.first_name;
                _this.lname = data.data.last_name;
                _this.email = data.data.email;

                if (data.data.profile_picture == '' || data.data.profile_picture == null) {
                  _this.picUrl = _this.picUrl;
                } else {
                  _this.picUrl = data.data.profile_picture;
                }

                if (data.data.per_hour_rate == '' || data.data.per_hour_rate == null) {
                  _this.price = 'None';
                } else {
                  _this.price = data.data.per_hour_rate;
                }

                if (data.data.mobile_number == '' || data.data.mobile_number == null) {
                  _this.mobilenumber = 'None';
                } else {
                  _this.mobilenumber = data.data.mobile_number;
                }

                if (data.data.street_address == '' || data.data.street_address == null) {
                  _this.address = 'None';
                } else {
                  _this.address = data.data.street_address;
                }
                ...
                if (data.data.bank_name == '' || data.data.bank_name == null) {
                  ...
                  _this.bankname = data.data.bank_name;
                }

                if (data.data.account_number == '' || data.data.account_number == null) {
                  _this.accountnumber = 'None';
                } else {
                  _this.accountnumber = data.data.account_number;
                }
