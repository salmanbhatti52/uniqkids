...
module.exports = __webpack_require__(/*! /Users/salmanahmad/Desktop/uniqkidz/src/main.ts */"zUnb");
...
let AppComponent = class AppComponent {
    ...
    constructor(navCtrl, menuCtrl, userService, oneSignal, router, platform, ngZone, rest, statusbar
...
/* harmony import */ var _ionic_native_stripe_ngx__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @ionic-native/stripe/ngx */ "tF4M");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "LoginwithuserService", function() { return LoginwithuserService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "mrSG");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "fXoL");
...
let LoginwithuserService = class LoginwithuserService {
    ...
    setSideMenu(type) {
        if (type === "Parent") {
            ...
            this.appPages = [
                { title: 'Profile', url: '/parentprofileview', img: '/assets/imgs/icons/user.svg' },
                { title: 'Child', url: '/child', img: '/assets/imgs/icons/child.svg' },
                { title: 'Caregiver', url: '/caregiver', img: '/assets/imgs/icons/caregiver.svg' },
                { title: 'Chat', url: '/chat', img: '/assets/imgs/icons/chat.svg' },
                { title: 'Payment', url: '/paymentto', img: '/assets/imgs/icons/payment.svg' },
                { title: 'Notifications', url: '/notification', img: '/assets/imgs/icons/notification.svg' },
                { title: 'Requests', url: '/requests', img: '/assets/imgs/icons/requests.svg' },
                { title: 'Terms and Condition', url: '/termsandcondition', img: '/assets/imgs/icons/term.svg' },
            ];
        }
        if (type === "Professional") {
            this.userType = "Professional";
            this.appPages = [
                { title: 'Profile', url: '/cgviewprofile', img: '/assets/imgs/icons/user.svg' },
                { title: 'Requests', url: '/requests1', img: '/assets/imgs/icons/requests.svg' },
                { title: 'Chat', url: '/chat', img: '/assets/imgs/icons/chat.svg' },
                { title: 'Earnings', url: '/earning', img: '/assets/imgs/icons/money.svg' },
                { title: 'Notifications', url: '/notification', img: '/assets/imgs/icons/notification.svg' },
                { title: 'Terms and Condition', url: '/termsandcondition', img: '/assets/imgs/icons/term.svg' },
            ];
        }
...
LoginwithuserService.ctorParameters = () => [];
LoginwithuserService = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
        providedIn: 'root'
    })
...
const routes = [
    ...
    {
        path: 'registeras',
        loadChildren: () => __webpack_require__.e(/*! import() | registeras-registeras-module */ "registeras-registeras-module").then(__webpack_require__.bind(null, /*! ./registeras/registeras.module */ "wPbW")).then(m => m.RegisterasPageModule)
    },
    {
        path: 'signin',
    ...
    {
        path: 'cgprofile',
        loadChildren: () => __webpack_require__.e(/*! import() | cgprofile-cgprofile-module */ "cgprofile-cgprofile-module").then(__webpack_require__.bind(null, /*! ./cgprofile/cgprofile.module */ "Fjb3")).then(m => m.CgprofilePageModule)
    },
    {
        path: 'parentprofile',
        loadChildren: () => __webpack_require__.e(/*! import() | parentprofile-parentprofile-module */ "parentprofile-parentprofile-module").then(__webpack_require__.bind(null, /*! ./parentprofile/parentprofile.module */ "+wJU")).then(m => m.ParentprofilePageModule)
    },
    {
        path: 'homescreen',
        loadChildren: () => Promise.all(/*! import() | homescreen-homescreen-module */[__webpack_require__.e("default~earning-earning-module~homescreen-homescreen-module~inbox-inbox-module~notification-notifica~ac9d4235"), __webpack_require__.e("common"), __webpack_require__.e("homescreen-homescreen-module")]).then(__webpack_require__.bind(null, /*! ./homescreen/homescreen.module */ "lPtD")).then(m => m.HomescreenPageModule)
    },
    {
        path: 'otp',
    ...
    {
        path: 'resetpassword',
        loadChildren: () => __webpack_require__.e(/*! import() | resetpassword-resetpassword-module */ "resetpassword-resetpassword-module").then(__webpack_require__.bind(null, /*! ./resetpassword/resetpassword.module */ "yIft")).then(m => m.ResetpasswordPageModule)
    },
    {
        path: 'termsandcondition',
        loadChildren: () => Promise.all(/*! import() | termsandcondition-termsandcondition-module */[__webpack_require__.e("common"), __webpack_require__.e("termsandcondition-termsandcondition-module")]).then(__webpack_require__.bind(null, /*! ./termsandcondition/termsandcondition.module */ "mcd0")).then(m => m.TermsandconditionPageModule)
    },
    {
        path: 'profile',
        loadChildren: () => Promise.all(/*! import() | profile-profile-module */[__webpack_require__.e("default~earning-earning-module~homescreen-homescreen-module~inbox-inbox-module~notification-notifica~ac9d4235"), __webpack_require__.e("default~profile-profile-module~requestpopup-requestpopup-module"), __webpack_require__.e("profile-profile-module")]).then(__webpack_require__.bind(null, /*! ./profile/profile.module */ "cRhG")).then(m => m.ProfilePageModule)
    },
    {
        path: 'onboarding',
    ...
    {
        path: 'child',
        loadChildren: () => __webpack_require__.e(/*! import() | child-child-module */ "child-child-module").then(__webpack_require__.bind(null, /*! ./child/child.module */ "utsK")).then(m => m.ChildPageModule)
    },
    {
        path: 'childprofile',
        loadChildren: () => Promise.all(/*! import() | childprofile-childprofile-module */[__webpack_require__.e("common"), __webpack_require__.e("childprofile-childprofile-module")]).then(__webpack_require__.bind(null, /*! ./childprofile/childprofile.module */ "BF4i")).then(m => m.ChildprofilePageModule)
    },
    {
        path: 'addchild',
        loadChildren: () => Promise.all(/*! import() | addchild-addchild-module */[__webpack_require__.e("common"), __webpack_require__.e("addchild-addchild-module")]).then(__webpack_require__.bind(null, /*! ./addchild/addchild.module */ "LGv1")).then(m => m.AddchildPageModule)
    },
    {
        path: 'medicationtime',
        loadChildren: () => Promise.all(/*! import() | medicationtime-medicationtime-module */[__webpack_require__.e("common"), __webpack_require__.e("medicationtime-medicationtime-module")]).then(__webpack_require__.bind(null, /*! ./medicationtime/medicationtime.module */ "9oeA")).then(m => m.MedicationtimePageModule)
    },
    {
        path: 'caregiver',
        loadChildren: () => __webpack_require__.e(/*! import() | caregiver-caregiver-module */ "caregiver-caregiver-module").then(__webpack_require__.bind(null, /*! ./caregiver/caregiver.module */ "khTF")).then(m => m.CaregiverPageModule)
    },
    {
        path: 'chat',
    ...
    {
        path: 'inbox',
        loadChildren: () => Promise.all(/*! import() | inbox-inbox-module */[__webpack_require__.e("default~earning-earning-module~homescreen-homescreen-module~inbox-inbox-module~notification-notifica~ac9d4235"), __webpack_require__.e("inbox-inbox-module")]).then(__webpack_require__.bind(null, /*! ./inbox/inbox.module */ "5gel")).then(m => m.InboxPageModule)
    },
    {
        path: 'payment',
        loadChildren: () => Promise.all(/*! import() | payment-payment-module */[__webpack_require__.e("default~earning-earning-module~homescreen-homescreen-module~inbox-inbox-module~notification-notifica~ac9d4235"), __webpack_require__.e("payment-payment-module")]).then(__webpack_require__.bind(null, /*! ./payment/payment.module */ "NSaA")).then(m => m.PaymentPageModule)
    },
    {
        path: 'paymentto',
        loadChildren: () => Promise.all(/*! import() | paymentto-paymentto-module */[__webpack_require__.e("default~earning-earning-module~homescreen-homescreen-module~inbox-inbox-module~notification-notifica~ac9d4235"), __webpack_require__.e("common"), __webpack_require__.e("paymentto-paymentto-module")]).then(__webpack_require__.bind(null, /*! ./paymentto/paymentto.module */ "8gnd")).then(m => m.PaymenttoPageModule)
    },
    {
        path: 'paymenthistory',
        loadChildren: () => __webpack_require__.e(/*! import() | paymenthistory-paymenthistory-module */ "paymenthistory-paymenthistory-module").then(__webpack_require__.bind(null, /*! ./paymenthistory/paymenthistory.module */ "EDAp")).then(m => m.PaymenthistoryPageModule)
    },
    {
        path: 'notification',
        loadChildren: () => Promise.all(/*! import() | notification-notification-module */[__webpack_require__.e("default~earning-earning-module~homescreen-homescreen-module~inbox-inbox-module~notification-notifica~ac9d4235"), __webpack_require__.e("notification-notification-module")]).then(__webpack_require__.bind(null, /*! ./notification/notification.module */ "TLzw")).then(m => m.NotificationPageModule)
    },
    {
        path: 'requests',
        loadChildren: () => __webpack_require__.e(/*! import() | requests-requests-module */ "requests-requests-module").then(__webpack_require__.bind(null, /*! ./requests/requests.module */ "q2Y4")).then(m => m.RequestsPageModule)
    },
    {
        path: 'earning',
        loadChildren: () => Promise.all(/*! import() | earning-earning-module */[__webpack_require__.e("default~earning-earning-module~homescreen-homescreen-module~inbox-inbox-module~notification-notifica~ac9d4235"), __webpack_require__.e("earning-earning-module")]).then(__webpack_require__.bind(null, /*! ./earning/earning.module */ "3OxA")).then(m => m.EarningPageModule)
    },
    {
        path: 'paymenthistory1',
        loadChildren: () => __webpack_require__.e(/*! import() | paymenthistory1-paymenthistory1-module */ "paymenthistory1-paymenthistory1-module").then(__webpack_require__.bind(null, /*! ./paymenthistory1/paymenthistory1.module */ "+vEZ")).then(m => m.Paymenthistory1PageModule)
    },
    {
        path: 'parentprofileview',
        loadChildren: () => __webpack_require__.e(/*! import() | parentprofileview-parentprofileview-module */ "parentprofileview-parentprofileview-module").then(__webpack_require__.bind(null, /*! ./parentprofileview/parentprofileview.module */ "82yy")).then(m => m.ParentprofileviewPageModule)
    },
    {
        path: 'childprofile1',
        loadChildren: () => __webpack_require__.e(/*! import() | childprofile1-childprofile1-module */ "childprofile1-childprofile1-module").then(__webpack_require__.bind(null, /*! ./childprofile1/childprofile1.module */ "hPhd")).then(m => m.Childprofile1PageModule)
    },
    {
        path: 'requests1',
        loadChildren: () => __webpack_require__.e(/*! import() | requests1-requests1-module */ "requests1-requests1-module").then(__webpack_require__.bind(null, /*! ./requests1/requests1.module */ "OCuJ")).then(m => m.Requests1PageModule)
    },
    {
        path: 'cgviewprofile',
        loadChildren: () => __webpack_require__.e(/*! import() | cgviewprofile-cgviewprofile-module */ "cgviewprofile-cgviewprofile-module").then(__webpack_require__.bind(null, /*! ./cgviewprofile/cgviewprofile.module */ "1bxe")).then(m => m.CgviewprofilePageModule)
    },
    {
        path: 'requestpopup',
        loadChildren: () => Promise.all(/*! import() | requestpopup-requestpopup-module */[__webpack_require__.e("default~earning-earning-module~homescreen-homescreen-module~inbox-inbox-module~notification-notifica~ac9d4235"), __webpack_require__.e("default~profile-profile-module~requestpopup-requestpopup-module"), __webpack_require__.e("requestpopup-requestpopup-module")]).then(__webpack_require__.bind(null, /*! ./requestpopup/requestpopup.module */ "6Kx3")).then(m => m.RequestpopupPageModule)
    },
    {
        path: 'eatingtime',
        loadChildren: () => Promise.all(/*! import() | eatingtime-eatingtime-module */[__webpack_require__.e("common"), __webpack_require__.e("eatingtime-eatingtime-module")]).then(__webpack_require__.bind(null, /*! ./eatingtime/eatingtime.module */ "mhrQ")).then(m => m.EatingtimePageModule)
    },
    {
        path: 'snacktime',
        loadChildren: () => Promise.all(/*! import() | snacktime-snacktime-module */[__webpack_require__.e("common"), __webpack_require__.e("snacktime-snacktime-module")]).then(__webpack_require__.bind(null, /*! ./snacktime/snacktime.module */ "pni9")).then(m => m.SnacktimePageModule)
    },
    {
        path: 'likes',
        loadChildren: () => Promise.all(/*! import() | likes-likes-module */[__webpack_require__.e("common"), __webpack_require__.e("likes-likes-module")]).then(__webpack_require__.bind(null, /*! ./likes/likes.module */ "AS/b")).then(m => m.LikesPageModule)
    },
    {
        path: 'dislikes',
        loadChildren: () => Promise.all(/*! import() | dislikes-dislikes-module */[__webpack_require__.e("common"), __webpack_require__.e("dislikes-dislikes-module")]).then(__webpack_require__.bind(null, /*! ./dislikes/dislikes.module */ "gRpR")).then(m => m.DislikesPageModule)
    },
    {
        path: 'favoriteactivities',
        loadChildren: () => Promise.all(/*! import() | favoriteactivities-favoriteactivities-module */[__webpack_require__.e("common"), __webpack_require__.e("favoriteactivities-favoriteactivities-module")]).then(__webpack_require__.bind(null, /*! ./favoriteactivities/favoriteactivities.module */ "vwF2")).then(m => m.FavoriteactivitiesPageModule)
    },
    {
        path: 'cghomescreen',
        loadChildren: () => __webpack_require__.e(/*! import() | cghomescreen-cghomescreen-module */ "cghomescreen-cghomescreen-module").then(__webpack_require__.bind(null, /*! ./cghomescreen/cghomescreen.module */ "5jCD")).then(m => m.CghomescreenPageModule)
    },
    {
        path: 'cgprofile1',
        loadChildren: () => __webpack_require__.e(/*! import() | cgprofile1-cgprofile1-module */ "cgprofile1-cgprofile1-module").then(__webpack_require__.bind(null, /*! ./cgprofile1/cgprofile1.module */ "FhKm")).then(m => m.Cgprofile1PageModule)
    },
    {
        path: 'cgviewprofile1',
        loadChildren: () => __webpack_require__.e(/*! import() | cgviewprofile1-cgviewprofile1-module */ "cgviewprofile1-cgviewprofile1-module").then(__webpack_require__.bind(null, /*! ./cgviewprofile1/cgviewprofile1.module */ "3fgg")).then(m => m.Cgviewprofile1PageModule)
    },
    {
        path: 'profile1',
        loadChildren: () => __webpack_require__.e(/*! import() | profile1-profile1-module */ "profile1-profile1-module").then(__webpack_require__.bind(null, /*! ./profile1/profile1.module */ "30IB")).then(m => m.Profile1PageModule)
    },
    {
        path: 'agencyhomescreen',
        loadChildren: () => __webpack_require__.e(/*! import() | agencyhomescreen-agencyhomescreen-module */ "agencyhomescreen-agencyhomescreen-module").then(__webpack_require__.bind(null, /*! ./agencyhomescreen/agencyhomescreen.module */ "4JRw")).then(m => m.AgencyhomescreenPageModule)
    },
    {
        path: 'cgsignup',
        loadChildren: () => Promise.all(/*! import() | cgsignup-cgsignup-module */[__webpack_require__.e("common"), __webpack_require__.e("cgsignup-cgsignup-module")]).then(__webpack_require__.bind(null, /*! ./cgsignup/cgsignup.module */ "YcQ3")).then(m => m.CgsignupPageModule)
    },
    {
        path: 'editchild',
        loadChildren: () => Promise.all(/*! import() | editchild-editchild-module */[__webpack_require__.e("common"), __webpack_require__.e("editchild-editchild-module")]).then(__webpack_require__.bind(null, /*! ./editchild/editchild.module */ "+I5a")).then(m => m.EditchildPageModule)
    },
    {
        path: 'editmedication',
        loadChildren: () => Promise.all(/*! import() | editmedication-editmedication-module */[__webpack_require__.e("common"), __webpack_require__.e("editmedication-editmedication-module")]).then(__webpack_require__.bind(null, /*! ./editmedication/editmedication.module */ "KWN/")).then(m => m.EditmedicationPageModule)
    },
    {
        path: 'editeating',
        loadChildren: () => Promise.all(/*! import() | editeating-editeating-module */[__webpack_require__.e("common"), __webpack_require__.e("editeating-editeating-module")]).then(__webpack_require__.bind(null, /*! ./editeating/editeating.module */ "x/RH")).then(m => m.EditeatingPageModule)
    },
    {
        path: 'editsnack',
        loadChildren: () => Promise.all(/*! import() | editsnack-editsnack-module */[__webpack_require__.e("common"), __webpack_require__.e("editsnack-editsnack-module")]).then(__webpack_require__.bind(null, /*! ./editsnack/editsnack.module */ "J22e")).then(m => m.EditsnackPageModule)
    },
    {
        path: 'editlikes',
        loadChildren: () => Promise.all(/*! import() | editlikes-editlikes-module */[__webpack_require__.e("common"), __webpack_require__.e("editlikes-editlikes-module")]).then(__webpack_require__.bind(null, /*! ./editlikes/editlikes.module */ "6y4q")).then(m => m.EditlikesPageModule)
    },
    {
        path: 'editdislikes',
        loadChildren: () => Promise.all(/*! import() | editdislikes-editdislikes-module */[__webpack_require__.e("common"), __webpack_require__.e("editdislikes-editdislikes-module")]).then(__webpack_require__.bind(null, /*! ./editdislikes/editdislikes.module */ "EnM8")).then(m => m.EditdislikesPageModule)
    },
    {
        path: 'editfavorite',
        loadChildren: () => Promise.all(/*! import() | editfavorite-editfavorite-module */[__webpack_require__.e("common"), __webpack_require__.e("editfavorite-editfavorite-module")]).then(__webpack_require__.bind(null, /*! ./editfavorite/editfavorite.module */ "WzWJ")).then(m => m.EditfavoritePageModule)
    },
    {
        path: 'paymentmessage',
        loadChildren: () => Promise.all(/*! import() | paymentmessage-paymentmessage-module */[__webpack_require__.e("common"), __webpack_require__.e("paymentmessage-paymentmessage-module")]).then(__webpack_require__.bind(null, /*! ./paymentmessage/paymentmessage.module */ "Zht2")).then(m => m.PaymentmessagePageModule)
    },
    {
        path: 'paymentdetail',
        loadChildren: () => __webpack_require__.e(/*! import() | paymentdetail-paymentdetail-module */ "paymentdetail-paymentdetail-module").then(__webpack_require__.bind(null, /*! ./paymentdetail/paymentdetail.module */ "B+1X")).then(m => m.PaymentdetailPageModule)
    },
    {
        path: 'onboarding1',
        loadChildren: () => __webpack_require__.e(/*! import() | onboarding1-onboarding1-module */ "onboarding1-onboarding1-module").then(__webpack_require__.bind(null, /*! ./onboarding1/onboarding1.module */ "ncPS")).then(m => m.Onboarding1PageModule)
    },
    {
        path: 'onboarding2',
        loadChildren: () => __webpack_require__.e(/*! import() | onboarding2-onboarding2-module */ "onboarding2-onboarding2-module").then(__webpack_require__.bind(null, /*! ./onboarding2/onboarding2.module */ "e5pD")).then(m => m.Onboarding2PageModule)
    },
    {
        path: 'cgprofile2',
        loadChildren: () => __webpack_require__.e(/*! import() | cgprofile2-cgprofile2-module */ "cgprofile2-cgprofile2-module").then(__webpack_require__.bind(null, /*! ./cgprofile2/cgprofile2.module */ "bNhQ")).then(m => m.Cgprofile2PageModule)
    },
    {
        path: 'editcgprofile2',
        loadChildren: () => __webpack_require__.e(/*! import() | editcgprofile2-editcgprofile2-module */ "editcgprofile2-editcgprofile2-module").then(__webpack_require__.bind(null, /*! ./editcgprofile2/editcgprofile2.module */ "twNt")).then(m => m.Editcgprofile2PageModule)
    }
];
